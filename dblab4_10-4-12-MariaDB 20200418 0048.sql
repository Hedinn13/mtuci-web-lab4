...
-- Дата скрипта: 18.04.2020 0:48:59
...
--
-- Таблица dblab4.auth_group не содержит данных
...
--
-- Таблица dblab4.auth_user_user_permissions не содержит данных

-- 
-- Вывод данных для таблицы auth_user_groups
--
-- Таблица dblab4.auth_user_groups не содержит данных

-- 
-- Вывод данных для таблицы auth_group_permissions
--
-- Таблица dblab4.auth_group_permissions не содержит данных
